...
draw_box_plot(filter_by_time(alld_long_format, c("2010-01-01", "2023-01-01")), "Change of unemployment rate - choosen european countries") + scale_y_continuous(breaks = seq(0, 100, by = 5)) + scale_x_date(date_breaks = "1 year", date_labels = "%Y")
